...
const LoginPage = () => {
  ...
  const googleLogin = useGoogleLogin({
    onSuccess: (tokenResponse) => {
      void dispatch(googleLoginThunk(tokenResponse.access_token)).then((action) => {
  ...
  return (
    ...
    >
        ...
        <button
          type="button"
          onClick={() => googleLogin()}
          className="mt-4 flex h-11 w-full items-center justify-center gap-2.5 rounded-full bg-slate-950 text-sm font-semibold text-white transition-colors hover:bg-slate-800"
        >
